...
var EventValues = []any{"newChecksum", "objectAdded", "objectDeleted", "objectModified", "getObject", "patchObject", "putObject", "ping", "batch", "exit"}
var ValuesToEvent = map[any]Event{
	...
	EventValues[EventExit]:           EventExit,
}
